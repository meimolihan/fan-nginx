...
import com.fan.sqlhelper.config.DataSourceEmbed;
import com.fan.sqlhelper.config.Table;
import com.fan.sqlhelper.utils.ConditionAndWrapper;
import com.fan.sqlhelper.utils.JdbcTemplate;
...
public class InitConfig {
	...
	private void showLogo() throws IOException {
		...
		stringBuilder.append("fan-nginx ").append(versionConfig.currentVersion).append("\n");
